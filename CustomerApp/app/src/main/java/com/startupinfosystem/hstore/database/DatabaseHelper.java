package com.startupinfosystem.hstore.database;
...
import static com.startupinfosystem.hstore.activity.HomeActivity.txtCountcard1;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String ICOL_9 = "bonus";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, PID TEXT , image TEXT ,title TEXT , weight TEXT , cost TEXT, qty TEXT , discount int , bonus TEXT)");
    }
    ...
    public boolean insertData(MyCart rModel) {
        if (getID(rModel.getPid(), rModel.getCost()) == -1) {
            ...
            contentValues.put(ICOL_9, rModel.getBonus());

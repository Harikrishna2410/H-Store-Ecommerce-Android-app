...
import com.startupinfosystem.hstore.adepter.ReletedItemAllAdp;
...
public class PopularFragment extends Fragment implements ReletedItemAllAdp.ItemClickListener {
    ...
    public void onItemClick(ProductItem productItem, int position) {
        getActivity().startActivity(new Intent(getActivity(), ItemDetailsActivity.class).putExtra("MyClass", productItem).putParcelableArrayListExtra("MyList", productItem.getPrice()).putParcelableArrayListExtra("MyList1", productItem.getPbonus()));
    }
    @Override
